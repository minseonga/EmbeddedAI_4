...
### Ensure the MANO_RIGHT.pkl file is in the assets/models folder
###############################################################################
...
class MANO(nn.Module):
    def __init__(self):
        ...
        # src/mobilehand/mano.py -> src/mobilehand -> src -> ROOT
        ROOT = Path(__file__).resolve().parent.parent.parent
        file_path = ROOT / 'assets/models/MANO_RIGHT.pkl'
        
        if not file_path.exists():
            raise FileNotFoundError(
                f"[MobileHand] MANO model not found at {file_path}.\n"
                "Please download 'MANO_RIGHT.pkl' from http://mano.is.tue.mpg.de/ and place it there.\n"
